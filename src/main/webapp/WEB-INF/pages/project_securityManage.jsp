    ...
    <div class=" row wrapper white-bg" id="content-main">
        <ol class="breadcrumb" style="margin-left: 40px">
            <li style="font-size: 15px">
                <strong>
                    <a href="user-jmpHomepage">后台管理系统首页</a> >> <a href="user-jmpSecurityManage">安全性规则管理</a>
                </strong>
            </li>
        </ol>
    </div>
            ...
            <div class="panel-heading">
                <div class="panel-options col-md-2">
                    <ul class="nav nav-tabs">
                        <li class="active">
                            <a href="project_detail.html#tab-1" data-toggle="tab">安全性规则列表</a>
                        </li>
                    </ul>
                </div>
                <div style="float: left;margin-top: 10px" class="col-md-1">
                    <button type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#addUsable">新增安全性</button>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    window.actionEvents = {
        'click .Modified': function (e, value, row, index) {
            var id_security = parseInt(row.id_security);
            var name = row.name;
            swal(
                {
                    title: "您确定修改第"+id_security+"条规则"+"“"+name+"”吗？",
                            ...
                            success: function (result) {
                                if (result.res === true) {
                                    swal({
                                        ...
                                        location.href = "user-jmpSecurityManage";
                                    })
                                }
