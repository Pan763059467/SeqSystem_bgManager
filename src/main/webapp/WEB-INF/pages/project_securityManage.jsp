    ...
    <div class=" row wrapper white-bg" id="content-main">
        <ol class="breadcrumb" style="margin-left: 40px">
            <li style="font-size: 15px">
                <strong>
                    <a href="user-jmpHomepage">后台管理系统首页</a> >> <a href="user-jmpSecurityManage">安全性模式管理</a>
                </strong>
            </li>
        </ol>
    </div>
            ...
            <div class="panel-heading">
                <div class="panel-options col-md-2">
                    <ul class="nav nav-tabs">
                        <li class="active">
                            <a href="project_detail.html#tab-1" data-toggle="tab">安全性模式列表</a>
                        </li>
                    </ul>
                </div>
...
<script type="text/javascript">
    ...
    window.actionEvents = {
        'click .Modified': function (e, value, row, index) {
            ...
            swal(
                {
                    title: "您确定修改第"+id_security+"条模式"+"“"+name+"”吗？",
